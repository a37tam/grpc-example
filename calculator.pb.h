...
PROTOBUF_NAMESPACE_OPEN
template<> ::Number* Arena::CreateMaybeMessage<::Number>(Arena*);
PROTOBUF_NAMESPACE_CLOSE

// ===================================================================

class Number final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Number) */ {
 public:
...
// int32 n = 1;
inline void Number::clear_n() {
  n_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Number::_internal_n() const {
  return n_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Number::n() const {
  // @@protoc_insertion_point(field_get:Number.n)
  return _internal_n();
}
inline void Number::_internal_set_n(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  n_ = value;
}
inline void Number::set_n(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_n(value);
  // @@protoc_insertion_point(field_set:Number.n)
}
